...
<head>
    ...
    <link rel="stylesheet" href="../cssAdmin/AgregarProducto.css?v=1.0">
</head>
<body>
    ...
    <div class="main-content">
        <header>
            <div class="header-title">
                <h1>PRODUCTOS - AGREGAR PRODUCTO</h1>
            </div>
        </header>
        ...
        <div class="form-container">
            <form action="procesar_producto.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea id="descripcion" name="descripcion" placeholder="Ingrese una descripción del producto" required></textarea>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-select-wrapper">
                            <div class="custom-select">
                                <div class="custom-select-display"><span>Seleccione una categoría</span></div>
